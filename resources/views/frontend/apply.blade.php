    ...
    <body class="font-poppins text-[#0E0140] pb-[100px] overflow-x-hidden">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('frontend.apply.store', $companyJob->slug) }}"
            ...
            <div id="Title" class="flex flex-col pt-[60px] gap-[10px]">
                ...
                @else
                    <p id="ClosedBadge" class="rounded-full p-[8px_20px] bg-[#FF6B2C] font-bold text-white w-fit">CLOSED</p>
                @endif
            ...
            <div id="Feature" class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-[6px]">
                    ...
                    <p class="font-semibold text-lg leading-[27px]">
                        Rp{{ number_format($companyJob->salary, 0, ',', '.') }}/Mo</p>
                </div>
                <div class="flex items-center gap-[6px]">
                    <div class="flex shrink-0 w-[38px] h-[38px]">
            ...
            {{-- Menampilkan pesan error apabila sudah apply --}}
            @if ($errors->any())
                <div class="bg-red-500 text-white py-3 w-full alert alert-danger">
            ...
            <div id="Resume-Container" class="flex flex-col gap-4">
                ...
                <div
                    ...
                    <button type="button" id="fileButton" class="font-semibold w-full text-left outline-none"
